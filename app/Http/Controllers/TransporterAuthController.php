...
class TransporterAuthController extends Controller
{
    ...
    public function downloadFeriExcelTemplate()
    {
        ...
        $cfAgents = ['AGL', 'CARGO CONGO', 'CONNEX', 'African Logistics', 'Afritac', 'Amicongo', 'OLA', 'Aristote', 'Bollore', 'Brasimba', 'Brasimba S.A', 'COSMOS', 'C-LINK SARL', 'Chemaf', 'Comexas Afrique', 'Comexas', 'DCG', 'DOUANE EXPRESS CUSTOMS', 'Evele & Co', 'Gecotrans', 'Global Logistics', 'Malabar', 'Polytra', 'Spedag', 'Tradecorp', 'Trade Service'];
