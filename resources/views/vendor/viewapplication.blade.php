                    ...
                    <div class="card-body tab-pane fade active show" id="tabs-home-1" role="tabpanel">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-4 mb-3">
                                ...
                                @if ($record->status < 2)
                                    <select class="form-select" name="transporter_company" disabled>
                            ...
                            <div class="col-12 col-lg-6 mb-3">
                                ...
                                <input type="date" class="form-control" name="arrival_date"
                                    value="{{ $record->arrival_date }}" autocomplete="on" disabled />
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 mb-3 col-lg-4">
                                ...
                                <input type="text" name="quantity" class="form-control"
                                    value="{{ round($record->quantity) }}" disabled>
                            </div>
                            <div class="col-12 mb-3 col-lg-4">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Change the
                                                        document</h1>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-md-6 mb-3">
                                                                ...
                                                                <input type="number" step="0.0001" min="0"
                                                                    class="form-control" name="euro_rate"
                                                            ...
                                                            <div class="col-12 col-md-6 mb-3">
                                                                ...
                                                                <input type="number" step="0.0001" min="0"
                                                                    class="form-control" name="tz_rate"
                                                                    value="{{ round((float) $rates->tz->amount, 2) }}"
                                                                    autocomplete="on" required />
                                                            </div>

                                                            <input type="hidden" step="1" min="0"
                                                                class="form-control" name="feri_quantity"
                                                                value="{{ $invoice->feri_quantity ?? '' }}"
                                                                autocomplete="on" required />

                                                            <div class="col-12 col-md-6 mb-3">
                                                                <label class="form-label">Feri Cost Per ton/cbm Unit
                                                                    Cost</label>
                                                                <input type="number" class="form-control"
                                                                    name="feri_units"
                                                                    value="{{ $invoice->feri_units ?? '' }}"
                                                                    autocomplete="on" required />
                                                            </div>

                                                            <div class="col-12 col-md-6 mb-3">
                                                                <label class="form-label">Feri/COD Certificate Admin
                                                                    Quantity</label>
                                                                <input type="number" step="1" min="0"
                                                                    class="form-control" name="cod_quantities"
                                                                    value="{{ $invoice->cod_quantities ?? '' }}"
                                                                    autocomplete="on" required />
                                                            </div>

                                                            <div class="col-12 col-md-6 mb-3">
                                                                <label class="form-label">Feri/COD Certificate Admin Unit
                                                                    Cost</label>
                                                                <input type="text" class="form-control"
                                                                    name="cod_units"
                                                                    value="{{ $invoice->cod_units ?? '' }}"
                                                                    autocomplete="on" required />
                                                            </div>

                                                            <input type="hidden" step="1" min="0"
                                                                class="form-control" name="transporter_quantity"
                                                                value="{{ $record->additional_fees_value + $record->freight_value }}"
                                                                autocomplete="on" required />

                                                            <input type="hidden" class="form-control"
                                                                name="customer_ref" placeholder="e.g. 11080320 -ALE 708"
                                                                autocomplete="on"
                                                                value="{{ trim(Str::before($record->company_ref, '-')) }}"
                                                                required />
                                                            ...
                                                            <input type="hidden" class="form-control"
                                                                name="customer_trip_no"
                                                                value="{{ $invoice->customer_trip_no ?? '' }}"
                                                                autocomplete="on" required />

                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="recipient-name" class="col-form-label">Change
                                                                Draft</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="number" step="1" min="0" class="form-control"
                                        name="cod_quantities" placeholder="e.g. 50" autocomplete="on" value="1"
                                        required />
                                </div>
