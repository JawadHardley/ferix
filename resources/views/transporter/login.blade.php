...
<div class="page page-center">
    <div class="container container-tight py-4">
        ...
        <div class="card card-md">
            <div class="card-body">
                <h2 class="h2 text-center mb-4">Transporter Login</h2>
                @if(session('message'))
                <!-- <div class="col-12"> -->
                ...
                @endif
                <form action="{{ route('transporter.login') }}" method="POST" autocomplete="off" novalidate="">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="text-center text-secondary mt-3">Don't have account yet? <a
                href="{{ route('transporter.register') }}" tabindex="-1">Sign
                up</a></div>
    </div>
</div>
